    ...
    <div className={`w-full ${widthFull ? "" : "lg:w-6/12"} px-4`}>
      <div className="relative w-full mb-3">
        ...
        <input
          ...
          } px-3 py-3 placeholder-slate-300 text-black bg-white border-slate-300 rounded text-sm border-[1px] focus:outline-none focus:ring w-full ease-linear transition-all duration-150`}
